...
# Provider: DeepSeek
# ==============================================================================
# Implements the DeepSeek API provider for zsh-ai-commands.
...
# Make API request to DeepSeek chat/completions endpoint
...
_zsh_ai_provider_make_request() {
    ...
    # Get API key
    _zsh_ai_provider_get_api_key || {
        echo "zsh-ai-commands::Error::No API key found for DeepSeek provider."
        echo "Please either:"
...
# Parse DeepSeek API response to extract command content
